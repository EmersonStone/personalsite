...
get_header(); ?>
		...
		<div class="container">
			<div class="introduction">
				...
				<h2 class="callout">A showcase of design projects done for previous clients. Learn more about each process in the case studies.</h2>
			</div>
		...
		<?php endif; ?>
			...
			<div class="standardservices">
				...
				<div class="services">
					...
					<p>A medium-agnostic approach to the colors, typography, style and visual personality of a brand. The guides and direction are for any type of design project as a company grows.</p>
					<h4>Information Architecture</h4>
					<p>Designing the various user flows for a website or application with a focus on usability and overall site structure.</p>
				</div>
				<div class="services">
					<h4>Digital Product Design</h4>
					<p>Working with the development and executive teams to plan and create digital products that meets business goals and delight users.</p>
					<h4>User-Interface Design</h4>
					<p>Creating all of the interactive design that goes in to marketing sites or digital applications on the web or mobile phone. Focus on usability, accessibility, and beautiful visual design.</p>
			...
			<div class="history">
				...
				<p>After a few years with Room 214, I decided to join the Mocavo team and go through Techstars Boulder. As one of the 3 founding members, I was again in charge of the company’s design, but I was also able to learn quite a bit about growing a business and focusing on a single product for a few years. It was an invaluable experience to watch as the team grew from just a few people to a large team spread across three states with a product used by millions of people.</p>
				<p>My most recent change occured in August 2013 when I left Mocavo to start my own design studio. I missed working on new design projects and also missed seeing a variety of clients after looking at a single digital product for a few years. Since then, I’ve taken my previous experiences of working with companies large and small to build out a company that can grow with me. The focus for <a href="http://emersonstone.com/">Emerson Stone</a> right now is to build lasting digital products that are as beautiful as they are useful.</p>
				<p>In my free time, I’m building an app for restaurant owners called Bistro with two of my closest friends and exploring beautiful Colorado with my wife.</p>
